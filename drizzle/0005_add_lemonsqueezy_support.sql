...
ALTER TABLE "checkout_sessions" ADD COLUMN IF NOT EXISTS "provider" text NOT NULL DEFAULT 'stripe';
--> statement-breakpoint
-- Add LemonSqueezy-specific columns
ALTER TABLE "checkout_sessions" ADD COLUMN IF NOT EXISTS "lemon_checkout_id" text UNIQUE;
--> statement-breakpoint
ALTER TABLE "checkout_sessions" ADD COLUMN IF NOT EXISTS "lemon_order_id" text UNIQUE;
--> statement-breakpoint
...
--> statement-breakpoint
-- Add index for LemonSqueezy lookup
